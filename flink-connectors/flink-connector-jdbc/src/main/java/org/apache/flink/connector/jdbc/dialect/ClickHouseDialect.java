...
public class ClickHouseDialect extends AbstractDialect {
    ...
    public String getDeleteStatement(String tableName, String[] fieldNames) {
        return getDeleteLogicallyStatement(tableName, fieldNames);
    }

    /**
     * Clickhouse 通过添加is_del字段标记，实现逻辑删除
     * @param tableName
     * @param fieldNames
     * @return
     */

    private String getDeleteLogicallyStatement(String tableName, String[] fieldNames) {
        String columns =
